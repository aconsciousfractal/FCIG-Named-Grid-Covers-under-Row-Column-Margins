...
\begin{center}
\small\emph{Public preprint, version 1.0.0. See the repository claim boundary and reproducibility package.}
\end{center}
...
\input{sections/03_exactness}
\input{sections/04_finite_libraries}
\input{sections/05_localization}
\input{sections/06_fpt}
\input{sections/07_types_energy}
\input{sections/08_p21}
\input{sections/09_limits}
\appendix
\input{sections/10_evidence}
